	...
	<div class="bx-breadcrumb">
			...
			<div class="bx-breadcrumb-item" id="bx_breadcrumb_1" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb" itemprop="child">
				...
				<a href="#" title="О компании" itemprop="url">
					<span itemprop="title">Заборы</span>
				</a>
			</div>
			<div class="bx-breadcrumb-item">
				<i class="fa fa-angle-right"></i>
				<span>Забор из металлического штакетника под ключ</span>
			</div><div style="clear:both"></div>
	</div>
<!--//BREADCRUMBS-->
<h1>Забор из металлического штакетника под ключ</h1>
<blockquote>
	Забор из металлического штакетника — это новый уровень во всем! Такое ограждение выбирают практичные люди, не лишенные вкуса, и стремящиеся к гармонии во всем!
	<p class="ta_right">Лензабор.ру</p>
</blockquote>

<div class="h2"><img src="images/h2_ico1.png"><span>Достоинства забора из металлического штакетника</span></div>

<ol>
	<li><b>Прочность.</b> Материал из которого сделан забор из металлического штакетника имеет разнообразную выштамповку профиля. Это обеспечивает ему преимущество в прочности перед другими типами полотна. Придает прочность всему каркасу, что позволяет крепить на него дополнительное оборудование (световые штанги, всевозможные датчики, защитные конструкции).</li>
	<li><b>Долговечность.</b> Современные системы обработки прокатного листового металла при помощи полимерного или порошкового покрытия позволяют не терять ему свои потребительские свойства на срок до 50 лет;</li>
	<li><b>Разнообразие по типоразмеру и цветовым решениям</b> дает возможность подбирать цвет по таблице RAL, выбрать ширину планок штакетника, их расположение и формовку. Все зависит от задач и эстетических предпочтений;</li>
	<li><b>Внешний вид забора из штакетника</b> остается привлекательным, как при использовании металлических, так и кирпичных столбов. Это очень важно, потому что, не любое полотно металлического забора хорошо сочетается с опорами разного типа.</li>
	<li>Текст текст</li>
</ol>
